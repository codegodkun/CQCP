...
const disjointness = validateTrackBSuccessorIndependence({
  successorCorpus: artifacts.corpus,
  historicalCorpus: JSON.parse(
    historicalCorpusBytes.toString("utf8")
  ),
...
try {
  ...
  if (error?.code === "EEXIST") {
    throw new Error(
      "Track B successor output is immutable and already exists"
    );
  }
  throw error;
}
...
const manifest = {
  schemaVersion:
    "task-eval-003-track-b-successor-preseal-manifest-v1",
