...
try {
    ...
    Invoke-Logged "d1-combined-452" (Join-Path $repo "apps/api-server") {
    ...
    Invoke-Logged "track-b-dispatch" $repo {
        node scripts/blind-evaluation/prepare-track-b-dispatch.mjs `
            . `
            verify `
