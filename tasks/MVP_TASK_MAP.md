...
| `TASK-EVAL-006` | L3 | R1-R4 模型评测 GO；R5/R6 失效；R7 subject `47d84299…` 因 CC package isolation `P0=1 / blocking=1` 失败；R8 verification PASS，freeze pending | human seal `0f23b9eb…` 早于模型访问；Codex/DeepSeek 六维 9/9、controls 3/3；R8 删除 content diff，改用 320 项 hash-only inventory，全包扫描 12 paths × 2 representations / 72 files 为 leak 0，sums `798c551c…`；正式 Node 56/56 + Java 1/1（5 executed），verification `3297f5c3…` / console `50288e22…` / evidence 42；新 freeze/三审前 `providerAdmissionEstablished=false`，A0/A1/A2 继续阻塞 |
