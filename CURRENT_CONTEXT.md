...
1. `TASK-GOV-004` 归档决策准备 / Codex Review Intake 结论为 `GO TO ARCHIVE PR PREP ONLY`；如获用户明确授权，仅可准备归档 PR 所需的文档提交与 PR 说明；不得直接归档 `TASK-GOV-004`，不得在未授权时 stage / commit / push / 创建 PR，不得进入 `TASK-028` / `TASK-031` / `TASK-032`。
