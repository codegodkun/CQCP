...
1. `TASK-GOV-004` 归档准备 Draft PR #8 已创建：`https://github.com/codegodkun/CQCP/pull/8`；下一步等待 required checks 完成后，按归档 PR 流程进行只读审查与用户合并/归档决策；不得直接归档 `TASK-GOV-004`，不得进入 `TASK-028` / `TASK-031` / `TASK-032`。
